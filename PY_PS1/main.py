...
def main():
    ...
    for name in name_array:
        ...
        # Note: We pass username/password for consistency, but the subprocess function ignores them
        # as it relies on the execution context for security.
    ...
    # Convert the collected list of dictionaries into a compact JSON string
    try:
        # Use json.dumps() to serialize the Python list of dicts to a JSON string
